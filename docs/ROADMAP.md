...
Status: implemented on `feature/0.5-link-insertion` and pending final acceptance and independent review. See [Explicit Link Insertion](LINK-INSERTION.md) and [0.5 Acceptance Criteria](ACCEPTANCE-0.5.md).
